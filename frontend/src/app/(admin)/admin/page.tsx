          ...
          <div className="space-y-3">
            ...
            <Panel title="Порядок онбординга">
              <ol className="space-y-2 text-[13px] leading-5 text-[#5f6b7a]">
                <li>1. Организация регистрируется и подтверждает email.</li>
                <li>2. Автоматически создаётся тикет проверки — переписка и документы.</li>
                <li>3. После активации в тикете организация получает полный доступ.</li>
              </ol>
            </Panel>
          </div>
        </div>
