...
export default function VendorOnboardingPage() {
  ...
  return (
    <VendorShell activePath="/app/vendor/onboarding" pageTitle="Статус компании" reviewBanner>
      <div className="mb-6">
        <h1 className="text-2xl font-medium tracking-tight text-[#18212f]">Статус компании</h1>
        <p className="mt-1 text-sm text-[#8a857d]">
          Заявка на подключение вашей организации к ASUTPORT. Приложите документы и переписывайтесь с платформой в блоке ниже.
        </p>
      </div>
      ...
      <div className="mb-6 rounded-lg border border-[#e8d9b3] bg-[#f6f0df] px-4 py-3 text-[13px] text-[#6d4a1f]">
        ...
        <p className="mt-2 pl-4 text-[12px] leading-5 text-[#9f7a3b]">
          Для производителя или поставщика: выписка ЕГРЮЛ, договор или письмо о полномочиях представителя,
          при необходимости — подтверждение права распространять документацию и поддержку.
        </p>
      </div>
      ...
      <p className="mt-6 text-sm">
        <Link href="/app/vendor" className="text-[#185fa5] hover:underline">
          ← Вернуться в кабинет
        </Link>
      </p>
    </VendorShell>
